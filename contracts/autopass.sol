...
contract Autopass is ReentrancyGuard, Ownable {
  ...
  function spendMoney(uint thirdPartyPay, address thirdPartyAddress) external payable {
  ...
  function retrieve(address spender, address thirdPartyAddress) public view returns (uint) {
